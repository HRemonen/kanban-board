...
const NewCardView = ({ onSubmit }: NewCardProps) => {
  ...
  return (
    <div className="max-w-sm py-3 pl-6 bg-white border-2 border-dashed border-gray-200 rounded-lg shadow">
      <form onSubmit={handleSubmit(onSubmit)} className="flex justify-between">
        ...
        <button
          type="submit"
          className="inline-flex items-center mr-4 text-gray-600 text-sm font-medium"
